...
export default function Create({ plans }) {
    ...
    return (
        <AdminLayout title="Yeni Tenant Yaradın">
            <Head title="Yeni Tenant" />
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                onChange={e => {
                                    ...
                                    if (!data.slug) setData('slug', e.target.value.toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, ''));
                                }}
                                placeholder="Məsələn: My Company"
                            />
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <textarea
                                ...
                                placeholder="Chatbot necə davranmalıdır?"
                            />
                        </div>
                    </CardContent>
                </Card>
